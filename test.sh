...
(sleep $delay; tmux send-keys -t 1 C-z; tmux kill-session -t my_session; echo All processes were finished after "$(tail -n 1 tmp/completed.txt | awk "{print \$NF}")" miliseconds) &
